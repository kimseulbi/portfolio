...
var logoEl = document.querySelector(".logo"); // 로고를 누르면 첫페이지로 이동
...
function drawMainPage() {
  return _drawMainPage.apply(this, arguments);
} // 배민찬 서브페이지
...
function _drawMainPage() {
  ...
  regeneratorRuntime.mark(function _callee() {
    var frag, baeminchanImgEl;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            // 1. 템플릿 복사
            frag = document.importNode(templates.main, true); // 2. 요소 선택

            baeminchanImgEl = frag.querySelector(".protfo__img--baeminchan"); // 5. 이벤트 리스너 등록하기
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            // 1. 템플릿 복사
            frag = document.importNode(templates.baeminchan, true); // 6. 템플릿을 문서에 삽입
